    ...
    return (
        <section id="project" className="about-project">
            ...
            <div className="about-project__steps">
                ...
                <p className="about-project__description-info about-project__description-info-backend">Back-end</p>
                <p className="about-project__description-info about-project__description-info-frontend">Front-end</p>
            </div>
        </section>
    )
}
